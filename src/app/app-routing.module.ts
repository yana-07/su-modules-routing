...
const routes: Routes = [
  {
    path: '',
    pathMatch: 'full', // дефолтно при промяна на адреса раутърът, започвайки от първия дефиниран раут, опитва да мачне на базата на префикс, т.е. 'currPath'.startsWith('definedPath')
    redirectTo: 'to-be-redirected' // https://angular.io/api/router/Route#pathMatch
  },
  {
